...
<%@ page import="com.RuoLiang.GetCar" %>
							...
							<nav class="main_nav">
								<ul>
									...
									<li class="active hassubs ">
										<a href="categories.jsp" >商品分类</a>
										<ul>
											<li><a href="categories.jsp?type=Phone">Phone</a></li>
											<li><a href="categories.jsp?type=Computer">Computer</a></li>
											<li><a href="categories.jsp?type=Smart Device">Smart Device</a></li>
										</ul>
									</li>
									<li><a href="#">我的收藏</a></li>
									...
									<li class="hassubs hassubs2_ul"><a href=""><% out.print(user.getNowName()); %>&nbsp</a>
										<ul style="text-align: center;">
											<li ><a href="signin.html">用户中心</a></li>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">商品分类<span>.</span></div>
				...
				<div class="col">
                    ...
                    <%
                        ...
                        if (request.getParameter("type")!=null){
                            String type = new String(new String((request.getParameter("type")).getBytes("ISO-8859-1"),"UTF-8"));
                            for (Good good :list){
					...
					<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
						<div class="results">共显示 <span><% out.print(list2.size()); %></span> 条结果</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
                        ...
                        <%
                            for (Good good : list2){
                                /*System.out.println(good.getGUrl());*/
                        %>

                        <div class="product">
                            <div class="product_image"><a class="product_a" href="product.jsp?thegid=<% out.print(good.getGID()); %>"><img src="<% out.print(good.getGUrl()); %>" alt=""></a></div>
                            <div class="product_extra product_new"><a href="categories.jsp">New</a></div>
                            <div class="product_content">
                                <div class="product_title"><a href="product.jsp?thegid=<% out.print(good.getGID()); %>"><% out.print(good.getGName()); %></a></div>
                                <div class="product_price">￥<% out.print(good.getGPrice()); %></div>
                            </div>
                        </div>
                        <%
                            }
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						<div class="newsletter_title">订阅我们的服务</div>
						<br>
