                                    ...
                                    <%
                                            ...
                                            %>
                                                <li class="hassubs hassubs2_ul"><a href=""><% out.print(user.getNowName()); %>&nbsp</a>
                                                    <ul style="text-align: center;">
                                                        <li ><a href="changeUser.jsp">用户中心</a></li>
                                                        <li><a href="signout.jsp">登 出</a></li>
                                                    </ul>
                                                </li>
                                    <%
                                        }
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">全新的网络购物体验</div>
										<div class="home_slider_subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie eros. Sed viverra velit venenatis fermentum luctus.</div>
										<div class="button button_light home_button"><a href="categories.jsp">Shop Now</a></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="avds_xl_container clearfix">
						...
						<div class="avds_xl_content">
							<div class="avds_title">令人难以置信的设备</div>
							<div class="avds_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus.</div>
							<div class="avds_link avds_xl_link"><a href="categories.jsp">了解更多</a></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title">全球范围内快速配送</div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title">七天无理由退货</div>
						<div class="icon_box_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie.</p>
						</div>
					</div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title">7*24 小时工单支持</div>
						<div class="icon_box_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie.</p>
						</div>
					</div>
